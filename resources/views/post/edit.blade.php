...
@section('container')
<h2>Edit post</h2>
<form action="/postUpdate/{{ $post->slug }}" method="post">
    @csrf
    ...
    <div class="mb-3">
      ...
      <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" required value="{{ old('slug',$post->slug) }}" readonly="" > 
      @error('slug')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <input type="text" name="exceprt" id="exceprt" class="form-control @error('exceprt') is-invalid @enderror" required value="{{ old('exceprt',$post->exceprt) }}"> 
      @error('exceprt')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
